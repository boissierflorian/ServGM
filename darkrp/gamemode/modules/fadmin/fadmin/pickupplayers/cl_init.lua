...
FAdmin.StartHooks["PickUpPlayers"] = function()
    ...
    FAdmin.ScoreBoard.Server:AddPlayerAction(function() return (AdminsCanPickUpPlayers:GetBool() and "Désactiver" or "Activer") .. " le pick Admin>Joueur" end,
    function() return "fadmin/icons/pickup", AdminsCanPickUpPlayers:GetBool() and "fadmin/icons/disable" end, Color(0, 155, 0, 255), function(ply) return ply:IsSuperAdmin() end, function(button)
        ...
        button:SetText((not AdminsCanPickUpPlayers:GetBool() and "Désactiver" or "Activer") .. " le pick Admin>Joueur")
        button:GetParent():InvalidateLayout()
        RunConsoleCommand("_FAdmin", "AdminsCanPickUpPlayers", AdminsCanPickUpPlayers:GetBool() and "0" or "1")
    end)

    FAdmin.ScoreBoard.Server:AddPlayerAction(function() return (PlayersCanPickUpPlayers:GetBool() and "Désactiver" or "Activer") .. " le pick Joueur>Joueur" end,
    function() return "fadmin/icons/pickup", PlayersCanPickUpPlayers:GetBool() and "fadmin/icons/disable" end, Color(0, 155, 0, 255), function(ply) return ply:IsSuperAdmin() end, function(button)
        ...
        button:SetText((not PlayersCanPickUpPlayers:GetBool() and "Désactiver" or "Activer") .. " le pick Joueur>Joueur")
        button:GetParent():InvalidateLayout()
