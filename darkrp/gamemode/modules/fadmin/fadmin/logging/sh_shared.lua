...
FAdmin.StartHooks["Logging"] = function()
    ...
    FAdmin.ScoreBoard.Server:AddServerSetting(function() return (logging:GetBool() and "Désactiver" or "Activer") .. " les logs" end,
    ...
    Color(0, 0, 155, 255), function(ply) return FAdmin.Access.PlayerHasPrivilege(ply, "Logging") end, function(button)
        ...
        button:SetText((not logging:GetBool() and "Désactiver" or "Activer") .. " les logs")
