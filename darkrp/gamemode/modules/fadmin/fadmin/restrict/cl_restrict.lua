...
local function RestrictWeaponMenu()
    ...
    frame:SetTitle("Restreindre des armes")
...
FAdmin.StartHooks["Restrict"] = function()
    ...
    FAdmin.ScoreBoard.Server:AddPlayerAction("Restreindre des armes", "fadmin/icons/weapon", Color(0, 155, 0, 255), function(ply) return FAdmin.Access.PlayerHasPrivilege(ply, "Restrict") end, RestrictWeaponMenu)
end
