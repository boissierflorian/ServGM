...
local function MakeServerOptions()
    ...
    FAdmin.ScoreBoard.Server.Controls.ServerActionsCat:SetLabel("  Serveur")
    ...
    FAdmin.ScoreBoard.Server.Controls.PlayerActionsCat:SetLabel("  Joueurs")
...
FAdmin.ScoreBoard.Server:AddInformation("Serveur", GetHostName)
FAdmin.ScoreBoard.Server:AddInformation("Mode de jeu", function() return GAMEMODE.Name end)
--FAdmin.ScoreBoard.Server:AddInformation("A", function() return GAMEMODE.Author end)
FAdmin.ScoreBoard.Server:AddInformation("Map", game.GetMap)
FAdmin.ScoreBoard.Server:AddInformation("Joueurs", function() return #player.GetAll() .. "/" .. game.MaxPlayers() end)
