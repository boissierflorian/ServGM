...
function FAdmin.ScoreBoard.ShowScoreBoard()
    ...
    FAdmin.ScoreBoard.Controls.Description:SetText("OptiRP")
	...
	-- TODO: Check pour les autres rangs administratifs
    ...
    FAdmin.ScoreBoard.Controls.ServerSettingsLabel:SetText("Paramètres du serveur")
