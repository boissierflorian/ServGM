local function God(ply, cmd, args)
    if not FAdmin.Access.PlayerHasPrivilege(ply, "God") then FAdmin.Messages.SendMessage(ply, 5, "Privilèges insuffisants !") return false end
...
FAdmin.StartHooks["God"] = function()
    FAdmin.Messages.RegisterNotification{
        name = "god",
        hasTarget = true,
        message = {"instigator", " a activé le godmode pour ", "targets"},
        receivers = "everyone",
    }
    ...
    FAdmin.Messages.RegisterNotification{
        name = "ungod",
        hasTarget = true,
        message = {"instigator", " a désactivé le godmode pour ", "targets"},
        receivers = "everyone",
    }
