...
FAdmin.StartHooks["zz_Teleport"] = function()
    ...
    FAdmin.ScoreBoard.Player:AddActionButton("Téléporter", "fadmin/icons/teleport", Color(0, 200, 0, 255),
    ...
    FAdmin.ScoreBoard.Player:AddActionButton("Amener", "fadmin/icons/teleport", Color(0, 200, 0, 255),
    function(ply) return FAdmin.Access.PlayerHasPrivilege(LocalPlayer(), "Teleport") and ply ~= LocalPlayer() end,
    function(ply, button)
