FAdmin.StartHooks["Health"] = function()
    FAdmin.Messages.RegisterNotification{
        name = "sethealth",
        hasTarget = true,
        message = {"instigator", " a mit les PV de ", "targets", " à ", "extraInfo.1"},
    ...
    FAdmin.ScoreBoard.Player:AddActionButton("Vie", "icon16/heart.png", Color(255, 130, 0, 255),
    ...
    function(ply, button) -- Create the Wang when the mouse is pressed
        button.OnMousePressed = function()
            local window = Derma_StringRequest("Définir les PV", "Combien de PV cette personne doit-elle avoir ?", "",
                function(text)
