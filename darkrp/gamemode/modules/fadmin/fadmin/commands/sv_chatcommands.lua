...
FAdmin.StartHooks["Chatcommands"] = function()
    ...
    FAdmin.Commands.AddCommand("CommandPrefix", function(ply, cmd, args)
        ...
        FAdmin.Messages.ActionMessage(ply, player.GetAll(), ply:Nick() .. " a défini le préfixe des commandes FAdmin en " .. args[1], 
			"Le préfixe des commandes FAdmin's est maintenant: " .. args[1], "Le préfixe des commandes est maintenant: " .. args[1])
